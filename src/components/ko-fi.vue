<template>
  <!-- Entire file taken from https://raw.githubusercontent.com/LinusBorg/vue-ko-fi-button/develop/src/KoFiButton.vue -->
  <div class="kofi-btn-container">
    <!--
      Markup taken from the original Ko-Fi button:
      https://ko-fi.com/widgets/widget_2.js
    -->
    <a v-bind:style="{ 'background-color': color }" :title="title" class="kofi-button" :href="href" target="_blank"
